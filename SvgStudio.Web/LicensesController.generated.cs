...
namespace SvgStudio.Web.Controllers
{
    public partial class LicensesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected LicensesController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public LicensesController Actions { get { return MVC.Licenses; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Licenses";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Licenses";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Add = "~/Views/Licenses/Add.cshtml";
            public readonly string Edit = "~/Views/Licenses/Edit.cshtml";
            public readonly string Index = "~/Views/Licenses/Index.cshtml";
            static readonly _EditorTemplatesClass s_EditorTemplates = new _EditorTemplatesClass();
            public _EditorTemplatesClass EditorTemplates { get { return s_EditorTemplates; } }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public partial class _EditorTemplatesClass
            {
                public readonly string LicenseViewModel = "LicenseViewModel";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LicensesController : SvgStudio.Web.Controllers.LicensesController
    {
        public T4MVC_LicensesController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, SvgStudio.Web.ViewModels.Licenses.LicenseViewModel model);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, SvgStudio.Web.ViewModels.Licenses.LicenseViewModel model);
